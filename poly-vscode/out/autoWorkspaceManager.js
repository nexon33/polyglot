...
exports.AutoWorkspaceManager = void 0;
const fs = require("fs");
...
class AutoWorkspaceManager {
     ...
     */
    createWorkspace(polyUri, rustCode) {
        ...
        fs.writeFileSync(path.join(workspacePath, 'rust-project.json'), JSON.stringify(rustProject, null, 2));
     ...
     */
    updateWorkspace(polyUri, rustCode) {
        const polyPath = polyUri.fsPath;
...
//# sourceMappingURL=autoWorkspaceManager.js.map